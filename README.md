...
| Scraper Script| Scraped Files    | Workflow File                             |
| :------------ |:----------------:| -----------------------------------------:|
...
| [Korea]       | [mcd-bs4-kr.csv] | [![scrape-kr-auto.yml][kr-logo]][kr-yaml] |
| [Malaysia]    | [mcd-bs4-my.csv] | [![scrape-my-auto.yml][my-logo]][my-yaml] |
| [New Zealand] | [mcd-scr-nz.csv] | [![scrape-nz-auto.yml][nz-logo]][nz-yaml] |
| [Pakistan]    | [mcd-bs4-pk.csv] | [![scrape-pk-auto.yml][pk-logo]][pk-yaml] |
| [Philippines] | [mcd-scr-ph.csv] | [![scrape-ph-auto.yml][ph-logo]][ph-yaml] |
| [Singapore]   | [mcd-bs4-sg.csv] | [![scrape-sg-auto.yml][sg-logo]][sg-yaml] |
| [Sri Lanka]   | [mcd-bs4-lk.csv] | [![scrape-lk-auto.yml][lk-logo]][lk-yaml] |
| [Taiwan]      | [mcd-bs4-tw.csv] | [![scrape-tw-auto.yml][tw-logo]][tw-yaml] |
| [Thailand]    | [mcd-bs4-th.csv] | [![scrape-th-auto.yml][th-logo]][th-yaml] |
| [Vietnam]     | [mcd-bs4-vn.csv] | [![scrape-vn-auto.yml][vn-logo]][vn-yaml] |
