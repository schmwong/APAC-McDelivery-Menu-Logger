...
try:
	...
	XE = BS(session.get("https://www.xe.com/currencyconverter/convert/?Amount=1&From=VND&To=USD",
	...
	for url in start_URLs:
	    ...
	    links = ("https://mcdelivery.vn/vn/browse/menu.html" + a["href"] + "&locale=en" for a in (
	    ...
	    for products in first_page.select("div.product-card"):
	        ...
	        product["Price (VND)"] = float((re.findall(r"[-+]?(?:\d*\,\d+|\d+)",
